...
using TryOutIOCContainer.Core;
using TryOutIOCContainer.Models;
using TryOutIOCContainer.Services;
using IContainer = TryOutIOCContainer.Core.IContainer;
        ...
        private object Resolve(Type t)
        {
            ...
            if(instanceRegistry.ContainsKey(t)==true)
            {
                ...
                if(model!=null)
                {
                    ...
                    var dependentCtor = consInfo.FirstOrDefault(item => item.CustomAttributes.
                                                     FirstOrDefault(att => att.AttributeType == typeof(TinyDependencyAttribute)) != null);
